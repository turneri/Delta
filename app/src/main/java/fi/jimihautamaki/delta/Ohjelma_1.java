...
public class Ohjelma_1 extends AppCompatActivity  {
    ...
    DBhelper DB;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Submit1.setOnClickListener(new View.OnClickListener() {
                ...
                if(checkinsertdata==true)
                    Toast.makeText(Ohjelma_1.this, "New Entry Inserted", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(Ohjelma_1.this, "New Entry Not Inserted", Toast.LENGTH_SHORT).show();
            }        });
        ...
        public void onClick(View tarkastele) {
            ...
            if(res.getCount()==0){
                Toast.makeText(Ohjelma_1.this, "No Entry Exists", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(Ohjelma_1.this);
